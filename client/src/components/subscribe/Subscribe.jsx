  ...
  return (
    <section className="box flex flex-col gap-10 mt-28 items-center">
      <div className="flex flex-col gap-2 items-center">
        ...
        Unlock unlimited access to our premium features and content with a one-time payment.
        <br /> Enjoy a lifetime subscription to our recipe website, ensuring you never miss out on the latest 
        culinary trends, delicious recipes, and exclusive content.
        </p>
      </div>
