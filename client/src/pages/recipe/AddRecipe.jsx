...
const AddRecipe = () => {
  useTitle("MuscleMeals- Add Recipe");
  ...
  return (
    <section className=" bg-addrecipe bg-contain bg-no-repeat flex flex-col gap-6 py-10 px-10">
      <h2 className="font-bold text-xl text-white">Add New Recipe</h2>
...
<hr className="block md:hidden mt-6" />
        {/* Upload recipe image */}
        <div className="basis-1/3 rounded-xl border border-primary  bg-white shadow-md hover:shadow-primary hover:shadow flex justify-center items-center w-full p-8 max-h-[300px]">
          <label
            htmlFor="image"
