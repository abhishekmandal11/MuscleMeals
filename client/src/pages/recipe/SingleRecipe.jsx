    ...
    <>
      {rest?.isLoading ? (
        ...
        <section className=" flex flex-col gap-8">
          <div className="bg-gradient-to-b from-orange-50 to-white flex flex-col md:flex-row gap-12 items-center pr-3">
            {/* Recipe image */}
            ...
            <div className="basis-2/3 flex flex-col gap-2">
              ...
              <div className="flex justify-between items-center">
                <p className="flex gap-2 items-center font-semibold text-primary">
                  <LuChefHat className="text-primary" />
                  {data?.author?.name}
                </p>
                <div className="flex gap-2 p-2 bg-light rounded-lg">
