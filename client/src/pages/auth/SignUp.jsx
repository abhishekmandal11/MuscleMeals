...
const SignUp = () => {
  ...
  return (
    <div className="hidden md:block basis-1/2 bg-login bg-no-repeat bg-cover bg-center">

    <section className="flex w-full h-screen ">
      {/* Sign up form container */}
      <div className="basis-1/3 m-auto flex flex-col bg-white md:p-10 p-10 rounded-3xl">
