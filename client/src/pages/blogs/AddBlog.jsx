...
const AddBlog = () => {
  ...
  return (
    <section className="bg-addblog bg-cover bg-no-repeat flex flex-col gap-6 py-14 px-7">
      <h2 className="font-bold text-xl text-white">Add New Blog</h2>
      <form
      ...
      >
        ...
        {/* Upload recipe image */}
        <div className="basis-1/3 rounded-xl border border-primary  bg-white hover:shadow-primary hover:shadow flex justify-center items-center w-full p-8 max-h-[300px]">
          <label
            htmlFor="image"
